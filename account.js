...
(function () {
  ...
  style.textContent =
    ...
    ".acc-box{width:100%;max-width:380px;background:var(--card-bg,#fff);color:var(--text-0,#241c16);border-radius:16px;padding:22px 22px 24px;box-shadow:0 24px 60px rgba(0,0,0,.4);font-family:var(--font,system-ui)}" +
    ".acc-box h3{font-family:var(--font-display,inherit);margin:0 0 4px;font-size:1.35rem;color:var(--green-ink,#4a2500)}" +
    ".acc-box p.acc-sub{margin:0 0 14px;color:var(--text-1,#5c5049);font-size:.86rem}" +
    ".acc-box input{width:100%;box-sizing:border-box;margin:6px 0;padding:11px 13px;border:1.5px solid rgba(74,37,0,.18);border-radius:10px;font-size:1rem;font-family:inherit;background:#fff;color:#241c16}" +
    ".acc-box input:focus{outline:none;border-color:var(--green,#b35900)}" +
    ...
    ".acc-btn.primary{background:var(--green,#b35900);color:#fff}" +
    ".acc-btn.ghost{background:transparent;color:var(--green,#b35900);border:1.5px solid var(--green,#b35900)}" +
    ".acc-btn.soft{background:var(--panel-2,rgba(179,89,0,.12));color:var(--green-ink,#4a2500)}" +
    ...
    ".acc-msg.err{color:#b3261e}.acc-msg.ok{color:var(--green,#b35900)}" +
    ".acc-x{float:right;background:none;border:none;font-size:1.3rem;cursor:pointer;color:var(--text-1,#5c5049);line-height:1;margin:-4px -4px 0 0}" +
    ".acc-mail{font-weight:700;color:var(--green-ink,#4a2500);word-break:break-all}" +
    ".acc-row{display:flex;gap:8px}.acc-row .acc-btn{margin-top:0}" +
    ".acc-link{display:block;width:100%;margin-top:10px;padding:4px;background:none;border:none;cursor:pointer;font-family:inherit;font-size:.82rem;color:var(--text-1,#5c5049);text-decoration:underline}" +
    ".acc-link:hover{color:var(--green,#b35900)}" +
  ...
  lbStyle.textContent =
    ".lb-box{width:100%;max-width:440px;max-height:82vh;overflow:auto;background:var(--card-bg,#fff);color:var(--text-0,#241c16);border-radius:16px;padding:20px 20px 22px;box-shadow:0 24px 60px rgba(0,0,0,.4);font-family:var(--font,system-ui)}" +
    ".lb-box h3{font-family:var(--font-display,inherit);margin:0 0 2px;font-size:1.3rem;color:var(--green-ink,#4a2500)}" +
    ".lb-tabs{display:flex;gap:6px;margin:12px 0 8px}" +
    ".lb-tab{flex:1;padding:8px 4px;border:1.5px solid rgba(74,37,0,.18);border-radius:9px;background:transparent;color:var(--text-1,#5c5049);font-weight:700;font-size:.82rem;cursor:pointer;font-family:inherit}" +
    ".lb-tab.on{background:var(--green,#b35900);color:#fff;border-color:var(--green,#b35900)}" +
    ".lb-me{margin:8px 0 4px;padding:9px 12px;border-radius:10px;background:var(--panel-2,rgba(179,89,0,.12));font-size:.88rem;font-weight:700;color:var(--green-ink,#4a2500)}" +
    ".lb-list{list-style:none;margin:6px 0 0;padding:0}" +
    ".lb-row{display:flex;align-items:center;gap:10px;padding:8px 6px;border-bottom:1px solid rgba(74,37,0,.08);font-size:.92rem}" +
    ".lb-row.mine{background:rgba(212,175,55,.16);border-radius:8px}" +
    ".lb-rank{min-width:2.1em;font-weight:800;color:var(--green,#b35900);text-align:right}" +
    ".lb-name{flex:1;font-weight:600;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}" +
    ".lb-pts{font-weight:800;color:var(--green-ink,#4a2500)}" +
    ".lb-sub{font-size:.8rem;color:var(--text-1,#5c5049);font-weight:400}" +
    ".lb-empty{padding:22px 4px;text-align:center;color:var(--text-1,#5c5049);font-size:.9rem}" +
    ".lb-row[data-pseudo]{cursor:pointer}.lb-row[data-pseudo]:hover{background:rgba(179,89,0,.08);border-radius:8px}" +
    ".fr-head{margin:14px 0 2px;font-size:.78rem;font-weight:800;letter-spacing:.04em;text-transform:uppercase;color:var(--text-1,#5c5049)}" +
    ...
    ".lb-tab.on .fr-badge{background:#fff;color:var(--green,#b35900)}" +
    ".pf-best{padding:12px 14px;border-radius:12px;background:var(--panel-2,rgba(179,89,0,.1));border-left:4px solid var(--gold,#ff8200)}" +
    ".pf-best-top{font-weight:800;font-size:1.05rem;color:var(--green-ink,#4a2500)}" +
    ".pf-best-title{font-size:.9rem;color:var(--text-1,#5c5049);margin:1px 0 6px}" +
    ".pf-best-stats{font-weight:700;font-size:.9rem;color:var(--green-ink,#4a2500)}" +
    ...
    ".pf-name{margin:0;font-family:var(--font-display,inherit);font-size:1.35rem;color:var(--green-ink,#4a2500);overflow:hidden;text-overflow:ellipsis;white-space:nowrap}" +
    ".pf-section{margin:20px 0 6px;font-size:.78rem;font-weight:800;letter-spacing:.04em;text-transform:uppercase;color:var(--text-1,#5c5049)}" +
    // Une carrière du Panthéon partagé. Même grammaire visuelle que .pf-best,
    // en plus compact puisqu'on en empile dix.
    ".pf-run{display:flex;align-items:center;gap:10px;padding:9px 11px;border-radius:10px;background:var(--card-bg-2,#f7f4f1);margin-bottom:7px}" +
    ".pf-run-rank{flex:none;min-width:1.8em;font-weight:800;color:var(--green,#b35900);text-align:right}" +
    ...
    ".pf-run-sub{display:block;font-size:.78rem;color:var(--text-1,#5c5049);overflow:hidden;text-overflow:ellipsis;white-space:nowrap}" +
    ".pf-run-score{flex:none;font-weight:800;color:var(--green-ink,#4a2500)}" +
    // Message affiché à qui n'est pas ami : on explique, on ne se contente pas
    // de masquer.
    ".pf-locked{padding:14px;border-radius:12px;background:var(--panel-2,rgba(179,89,0,.08));color:var(--text-1,#5c5049);font-size:.88rem;line-height:1.55;text-align:center}" +
    ".pf-counters span{flex:1;min-width:96px;text-align:center;padding:8px 4px;border-radius:9px;background:var(--panel-2,rgba(179,89,0,.1));font-weight:700;font-size:.82rem;color:var(--green-ink,#4a2500)}";
  ...
  async function renderSocial(msg, prefill) {
    ...
    if (soTab === "challenge") {
      ...
      content.innerHTML =
        ...
        '<input type="text" id="du-pseudo" maxlength="24" placeholder="Pseudo de l\'adversaire" value="' + esc(prefill || "") + '" style="width:100%;box-sizing:border-box;margin:0 0 8px;padding:11px 13px;border:1.5px solid rgba(74,37,0,.18);border-radius:10px;font-size:1rem" />' +
    ...
    if (soTab === "history") {
      ...
      if (hist.length) {
        ...
        html += '<ul class="lb-list">' + hist.map((r) => {
          ...
          const res = r.winner === "tie" ? '<span style="color:var(--text-1,#5c5049)">Nul</span>' : (r.winner === mine ? '<span style="color:var(--green,#b35900);font-weight:800">Victoire</span>' : '<span style="color:#b3261e;font-weight:800">Défaite</span>');
