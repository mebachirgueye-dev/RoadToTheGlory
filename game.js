...
(function () {
  ...
  async function shareDuel(url, btn) {
    const text = "🆚 Je te défie sur Road To The Glory — même profil, mêmes épreuves. Fais mieux que moi !";
    try {
  ...
  function spawnConfetti(container, count = 30) {
    const colors = ["#ff8200", "#ffd699", "#ffb347", "#cc6a00", "#ffffff"];
  ...
  window.addEventListener("DOMContentLoaded", () => {
    ...
    $("home-title").innerHTML = 'Road To The <span class="wm-glory">Glory</span>';
