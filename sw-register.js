...
(function () {
  ...
  function injectStyle() {
    ...
    st.textContent =
      ...
      "background:var(--card-bg,#fff);color:var(--green-ink,#4a2500);border:2px solid var(--gold,#ff8200);" +
      ...
      ".oe-up-btn{flex-shrink:0;background:var(--green,#b35900);color:#fff;border:none;border-radius:10px;" +
      ...
      ".oe-up-x{flex-shrink:0;background:transparent;border:none;color:var(--text-1,#5c5049);" +
